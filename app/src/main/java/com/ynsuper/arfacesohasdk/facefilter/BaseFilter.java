...
import com.ynsuper.arfacesohasdk.util.TextureRotationUtils;
...
public class BaseFilter {
    ...
    public int drawFrameBuffer(int textureId, FloatBuffer vertexBuffer, FloatBuffer textureBuffer) {
        //
        //If there is no FBO, no initialization, the input texture is invalid, or the filter is unavailable, return directly
    ...
    public void bindFrameBuffer() {
        ...
        // 使用当前的program
        GLES30.glUseProgram(mProgramHandle);
        // Run the delay task, this should be placed after the gl Use Program, otherwise some setting items will not take effect
        runPendingOnDrawTasks();
    }
